...
public class Assgn6 {
	...
	private static void modifyproject()
	{
		try 
		{
			...
			Thread.sleep(1000);
			wb.findElement(om.getLocator("projectmodifydescprition")).clear();
			Thread.sleep(1000);
			wb.findElement(om.getLocator("projectmodifydescprition")).sendKeys("Final details...");
			Thread.sleep(2000);
			wb.findElement(om.getLocator("projectclosebutton")).click();
			Thread.sleep(1000);
		} catch (Exception e) 
		{
			e.printStackTrace();
