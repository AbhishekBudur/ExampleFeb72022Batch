...
public class Assgn4 {
	...
	private static void modifycustomer()
	{
		try 
		{
			...
			Thread.sleep(2000);
			wb.findElement(om.getLocator("customermodification")).clear();
			Thread.sleep(1000);
			wb.findElement(om.getLocator("customermodification")).sendKeys("Final details after modification...");
			Thread.sleep(2000);
			wb.findElement(om.getLocator("customerclosebutton")).click();
			Thread.sleep(2000);
